...
TENCENTCLOUD_HUNYUAN_MODEL=3.1
```

混元 3D 使用腾讯云 API 3.0：`TENCENTCLOUD_SECRET_ID` 和 `TENCENTCLOUD_SECRET_KEY` 会通过 TC3-HMAC-SHA256 签名调用 `SubmitHunyuanTo3DProJob` / `QueryHunyuanTo3DProJob`。
