...
const editableSettings = [
  ...
  { key: "TENCENTCLOUD_SECRET_ID", label: "Tencent Cloud SecretId", secret: true, placeholder: "保存后不会回显" },
  { key: "TENCENTCLOUD_SECRET_KEY", label: "Tencent Cloud SecretKey", secret: true, placeholder: "保存后不会回显" },
];
